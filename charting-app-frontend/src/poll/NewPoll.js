...
class NewPoll extends Component {
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            if(error.status === 401) {
                this.props.handleLogout('/login', 'error', 'You have been logged out. Please login create Chart.');    
            } else {
                notification.error({
                    message: 'Charting App',
    ...
    validateQuestion = (questionText) => {
        if(questionText.length === 0) {
            return {
                ...
                errorMsg: 'Please enter your Stock!'
            }
    ...
    render() {
        ...
        return (
            <div className="new-poll-container">
                <h1 className="page-title">What would Be the Best?</h1>
                    ...
                    <Form onSubmit={this.handleSubmit} className="create-poll-form">
                        ...
                        <FormItem className="poll-form-row">
                            <Button type="primary" 
                                ...
                                className="create-poll-form-button">Create voting</Button>
                        </FormItem>
                    </Form>
                </div>    
            </div>
